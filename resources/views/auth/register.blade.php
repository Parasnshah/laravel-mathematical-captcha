            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Are you human?') }}</label>

                            <div class="col-md-6">
                                 <p>{{getCaptchaQuestion()}}</p>
                                 <input id="_answer" type="number" class="form-control @error('number') is-invalid @enderror" name="_answer" value="{{ old('_answer') }}" placeholder="Verification code">
                            <div class="text-danger">{{$errors->first('_answer')}}</div>
                            </div>
                        </div>
